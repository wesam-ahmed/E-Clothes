  ...
  getData() {
    ...
    EcommerceApp.firestore
      ...
      value["productIDs"].forEach((val) {
        var map = {"color": val["color"], "size": val["size"], "id": val["id"]};
        IDs.add(map);
                      ...
                      child: Column(
                        children: [
                         ...
                         /* Padding(
                          ...
                          Padding(
                            padding: EdgeInsets.all(4),
                            child: Text("Shipping State: " +
                                dataMap["shippingstate"].toString()),
                          ),
                          IconStepper(
                            icons: [
                              Icon(
                                      ...
                                      builder: (c, snap) {
                                        return snap.hasData
                                            ? OrderCardSize(
                                                itemCount: 1,
                                                data: snap.data.docs,
                                                ordercolor: IDs[index]["color"]
                                                    .toString(),
                                                ordersize: IDs[index]["size"]
                                                    .toString(),
                                              )
                                            : Center(
