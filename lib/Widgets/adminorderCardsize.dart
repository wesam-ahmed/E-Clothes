...
int counter=0;
class AdminOrderCardSize extends StatelessWidget {
final int itemCount;
...
AdminOrderCardSize({Key key,this.itemCount,this.data,this.orderId,this.ordercolor,this.ordersize}):super(key:key);
  @override
